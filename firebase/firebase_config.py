...
def get_credentials():
    ...
    if firebase_json_b64:
        try:
            ...
            raise ValueError(
                ...
                "Check that the complete Base64 Firebase "
                "service-account JSON is configured in Vercel."
            ) from exc
    ...
    raise FileNotFoundError(
        ...
        "For local development, place serviceAccountKey.json "
        "inside firebase/. For Vercel, configure "
        "FIREBASE_SERVICE_ACCOUNT_B64."
    )
